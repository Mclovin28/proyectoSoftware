...
public class PHDList extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        toClient.println("<div class= \".tableinfo\"><h1><strong>Mostrar Listado de PHD </strong></h1>"); // wrap the table with a div element
    ...
    toClient.print("<br><br><br>");
    toClient.print("<nav style=\"text-align: center;\"> <button onclick=\"logout()\" class=\"btn btn-outline-primary\" style=\"font-size: 14px; \">Logout</button></nav>");
