...
public class EventList extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        toClient.println("<tr><td>Event ID</td><td>Event Name</td><td>Lugar</td><td>Edit Info</td><td>Delete</td></tr>");
        Vector<EventData> eventList = EventData.getEventList(connection);
        ...
        for (int i = 0; i < eventList.size(); i++) {
            ...
            toClient.println("<td><a href='EventDelete?EventID=" + event.EventID + "' onclick='return confirm(\"Are you sure you want to delete this event?\");'>Delete</a></td>");
            toClient.println("</tr>");
        }
        ...
        toClient.println("<table border='1'>");
        toClient.println("<tr><td>Event Name</td><td>Lugar</td></tr>");
        toClient.println("<tr>");
